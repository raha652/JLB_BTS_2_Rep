const SHEET_URL = "https://script.google.com/macros/s/AKfycbxF11yyfeUYomRATqsVIQZTnSPR70Xzo-we5_LoJqrBitdOXwH9DyTmJy-GY-s4oFRh8g/exec";
...
const AVAILABLE_BASES = Array.from({ length: 6 }, (_, index) => `BTS_${index + 1}`);
